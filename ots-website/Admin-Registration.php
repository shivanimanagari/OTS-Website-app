...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Admins (Name,MailId,PhoneNumber,Password)  VALUES ('$Name', 
            '$MailId','$PhoneNumber','$Password')";
...
<body>
    ...
    <div class="container">
        <div class="Login-Card">
            ...
            <div class="UseName">
                <input type="email" placeholder="EmailId" name="MailId" required>
            </div>
            <div class="UseName">
            ...
            <div class="Password">
                <input id="Password" type="password" placeholder="ConfirmPassword" name="Password" required>
                <span id="PasswordShowHide" class="fa fa-eye-slash toggle-password"></span>
            </div>
            <button type="submit" class="Login-Button">
                <span><i class="fa fa-lock"></i></span> SignUp
            </button>
            <div>
                <p>Sign up with</p>
