...
<div class="webinars">
  <div class="page">
    ...
    <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
      ...
      <label for="tab1">Past Webinars</label>

      <input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
      <label for="tab2">Ongoing Webinars</label>

      <input type="radio" name="pcss3t" id="tab3" class="tab-content-3">
      <label for="tab3">Upcoming Webinars</label>
      <ul>
        <li class="tab-content tab-content-first typography">
          <h1>Past webinars</h1><br>
        ...
        <li class="tab-content tab-content-2 typography">
          <h1>Ongoing webinars</h1><br>
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="..." alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    </div>
                <button type="button" class="btn btn-success">Registerations closed</button>
            </div>
        </li>

        <li class="tab-content tab-content-3 typography">
          <h1>Upcoming webinars</h1><br>
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="..." alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
